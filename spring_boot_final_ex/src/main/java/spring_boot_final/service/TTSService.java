...
public class TTSService {
	...
	public String clovaTextToSpeech() {
		...
		String clientId = "lao4rzqixb";//애플리케이션 클라이언트 아이디값";
	 	String clientSecret = "Ysn0NYLgjYp8PFeX9JF66oWFWTPN1gVJcpE6prNG";//애플리케이션 클라이언트 시크릿값";
	...
	public String clovaTextToSpeech2(String filePathName, String language) {
		...
		return voiceFileName; //저장된 음성 파일명 변환
	}

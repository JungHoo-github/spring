...
<body>
    ...
    <form id="insertForm" name="insertForm" method="post"  action="<c:url value='/board/updateForm'/>">
     <br>

     <table id="insert">
    <input type="hidden" class="brdNo" id="brdNo" name="brdNo" value="${board.brdNo }">
        <tr><th>제목</th><td>
        <input type="text" class="form-control" id="brdTitle" name="brdTitle" value="${board.brdTitle }">
      </td></tr>
        <tr><th>작성자</th><td>
        <input type="text" class="form-control" id="memNo" name="memNo" value="${board.memNo }">
      </td></tr>
      <tr><th id="content">내용</th><td>
        <textarea class="form-control" name="brdCon" id="summernote" rows="5">${board.brdCon}</textarea>
      </td></tr>
      <tr><th>태그</th><td>
      	<input class="form-control" name="brdTag">
      </td></tr>
